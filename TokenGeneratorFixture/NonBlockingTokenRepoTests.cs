...
namespace TokenGeneratorFixture
{
  ...
  internal class ThreadFuncObj
  {
    ...
    internal TimeSpan ExtApiCallDuration { get; set; }// GTan: If tests fail randomly on build server, increase this time in tests... The thread scheduler may be busy.. Taking long time to schedule threadpool threads.
  }
}
